...
<a href="portal.php?mod=portalcp&amp;ac=comment&amp;op=hide&amp;cid=<?php echo $comment['cid'];?>" id="c_<?php echo $comment['cid'];?>_hide" onclick="showWindow(this.id, this.href, 'get', 0);">隐藏</a>
<?php } ?>
</span>
