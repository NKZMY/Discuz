...
$modules = array('extends', 'buyattachment', 'buythread', 'checkpost', 'connect',
		...
		'modcp', 'topicadmin', 'forumimage', 'newthreads', 'signin', 'smiley', 'threadrecommend','portalarticletitle','portalcategory','mysearcharticle','mysearchmember','mysearchcomment','portalupload');
