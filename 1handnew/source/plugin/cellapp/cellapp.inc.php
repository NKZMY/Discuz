...
$modules = array(
		...
		'portal','portalupload','profile','sellerprofile','auctionlist','auction','auctionbuy',
		'searchcomment','searchmember','searcharticle','scanqr','forumlist','forumthreadlist',
		'forumthread',
		'avatar',
		'test','advertisementvisit');
